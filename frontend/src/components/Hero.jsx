        ...
        <section className='flex flex-col sm:flex-row items-center justify-between px-6 sm:px-16 lg:px-24 py-20 sm:py-24'>
            ...
            <div className='w-full sm:w-1/2 text-center sm:text-left'>
                ...
                <div className='mt-6 flex gap-4 justify-center sm:justify-start'>
                    <button className='bg-green-600 text-white px-6 py-2 rounded-md transition hover:bg-green-700'>
                        Get Started →
                    </button>
                    <button className='border border-green-600 text-green-600 px-6 py-2 rounded-md transition hover:bg-green-100'>
                        Shop Now
                    </button>
                </div>
            </div>
