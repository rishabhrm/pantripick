    ...
    <div className='flex flex-col sm:flex-row items-center justify-between px-6 sm:px-16 lg:px-24 py-15'>
      ...
      <div className='w-full sm:w-1/2 text-center sm:text-left'>
        ...
        <p className='text-black mt-4 leading-relaxed'>
          Your trusted neighborhood grocery shop, dedicated to providing
          high-quality products that meet every shopper's needs.
        </p>
        <p className='text-black mt-2'>
          From fresh produce to daily essentials, we offer a wide selection of
          items.
        </p>
        ...
        <div className='mt-6'>
          <Link
            to='/about'
            className='border border-green-600 text-green-600 px-6 py-2 rounded-md transition hover:bg-green-600 hover:text-white shadow-sm'
          >
            Know More →
          </Link>
        </div>
