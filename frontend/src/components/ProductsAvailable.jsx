                        ...
                        <div className='relative'>
                            ...
                            >
                                {items.map((product, index) => (
                                    <div key={index} className='border-gray-300 border rounded-lg p-4 shadow-md w-40 sm:w-48 flex-shrink-0'>
                                        <div className='w-full h-36 sm:h-40 bg-blue-50 rounded-lg flex items-center justify-center'>
                                            <img className='max-h-32 sm:max-h-36 object-contain' src={product.image} alt={product.name} />
                                        </div>
