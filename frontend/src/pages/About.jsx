  ...
  return (
    <div className='px-6 sm:px-16 lg:px-24 py-15'>
      ...
      <p className='text-sm sm:text-base text-justify text-black leading-relaxed px-1 pt-4'>
        Welcome to PantriPick, your trusted neighborhood grocery shop. We are
        dedicated to providing a variety of high-quality products to meet the
        needs of every shopper. From fresh produce to everyday essentials, we
        aim to offer a wide selection of items to make your shopping experience
        convenient and enjoyable.
      </p>
      <p className='text-sm sm:text-base text-justify text-black leading-relaxed px-1 mt-4'>
        Our focus is on quality, service, and making sure you have access to the
        products you love. Whether you're coming in for a quick grocery run or
        preparing for a big meal, we are here to support you with friendly
        service and a great selection.
      </p>
      <p className='text-sm sm:text-base text-justify text-black leading-relaxed px-1 mt-4'>
