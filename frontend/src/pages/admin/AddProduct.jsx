...
const AddProduct = () => {
  ...
  const categories = ["Dairy and Bread", "Fruits and Vegetables", "Cold Drinks and Juice", "Snacks and Munchies", "Bakery and Biscuits", "Sauces and Spreads", "Pharma and Wellness", "Personal Care", "Cleaning Essentials", "Home and Offices"];
