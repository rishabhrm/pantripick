			...
			<div className='px-6 sm:px-16 lg:px-24 py-16'>
				...
				<div className='bg-gray-100 p-6 sm:p-8 rounded-lg shadow-lg'>
					<p className='text-sm sm:text-base text-gray-700 leading-relaxed text-justify'>
						Welcome to{' '}
						<span className='font-semibold text-black'>PantriPick</span>, your
						trusted neighborhood grocery store. Since our humble beginnings in
						1997 in Ahmedabad, we have been committed to bringing the best
